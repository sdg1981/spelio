...
with desired_order(id, order_index) as (
  values
    ...
    ('practice_most_common_places', 3),
    ('practice_most_common_travel_and_transport', 4),
    ('practice_most_common_people_and_family', 5),
    ('practice_most_common_home_and_household', 6),
