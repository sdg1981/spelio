...
function elevenLabsWord(
  id: string,
  overrides: Partial<Pick<AdminWord, 'audioUrl' | 'audioStatus' | 'elevenLabsAudioStatus'>> = {}
): Pick<AdminWord, 'id' | 'audioUrl' | 'audioStatus' | 'elevenLabsAudioStatus'> {
  return {
    id,
...
assert(canBulkGenerateElevenLabsAudio(elevenLabsWord('el-missing')), 'Missing ElevenLabs audio with ready Azure audio should be eligible.');
assert(canBulkGenerateElevenLabsAudio(elevenLabsWord('el-failed', { elevenLabsAudioStatus: 'failed' })), 'Failed ElevenLabs audio with ready Azure audio should be eligible.');
assert(!canBulkGenerateElevenLabsAudio(elevenLabsWord('el-generated', { elevenLabsAudioStatus: 'generated' })), 'Generated ElevenLabs audio should not be regenerated by the selected batch action.');
assert(!canBulkGenerateElevenLabsAudio(elevenLabsWord('el-no-azure-url', { audioUrl: '' })), 'ElevenLabs batch generation should require an Azure audio URL.');
assert(!canBulkGenerateElevenLabsAudio(elevenLabsWord('el-azure-missing', { audioStatus: 'missing' })), 'ElevenLabs batch generation should require ready Azure audio.');
