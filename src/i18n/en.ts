export const en = {
  ...
  home: {
    ...
    browseWordLists: 'Browse word lists',
  ...
  wordLists: {
    ...
    moreFoundationsChips: '+17 more',
    continueJourney: 'Continue journey',
    upcomingLearningJourneys: 'Upcoming learning journeys',
    upcomingWordFamilies: 'Word Families',
  ...
  footer: {
    ...
    aboutBody3: 'It helps learners build confidence in Welsh spelling through listening, recall, and repeated spelling practice.',
    aboutBody4: 'Welsh spelling can look unfamiliar at first, but it is often more predictable than it appears. Spelio is designed to help learners become more comfortable recognising Welsh spelling patterns, connecting spoken Welsh with written Welsh, and gradually developing real spelling confidence.',
    aboutBody5: 'The app is designed to complement other ways of learning Welsh rather than replace them.',
    aboutBody5ResourcePrefix: 'One of the resources that has helped me most is ',
    aboutBody5ResourceLinkText: 'SaySomethinginWelsh',
    aboutBody5ResourceSuffix: '. It\'s an excellent way to build confidence listening to and speaking Welsh through real conversation. Spelio was created to complement that kind of learning by helping learners connect the Welsh they hear with the Welsh they write through repeated spelling practice, while also making Welsh spelling feel more understandable through simple explanations of common spelling patterns and letter combinations. Together, they encourage different but complementary parts of the learning process.',
    aboutBody6: 'Spelio began while I was learning Welsh myself. I found that hearing words often wasn’t enough — I needed to see them, type them, and practise their spelling before they really stayed in my memory. I couldn’t find a tool that focused on that part of learning, so I started building the tool I wished already existed to sit alongside the other Welsh learning resources I was using.',
    aboutBody7: 'I’m not a Welsh teacher or a linguist — just someone who wanted to become better at spelling Welsh. Building Spelio has been part of that journey, and my own experience with dyslexia reinforced how valuable simple, repeated spelling practice can be.',
