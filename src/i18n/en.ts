export const en = {
  ...
  practice: {
    ...
    keyboardHint: 'Replay audio · Reveal next letter',
    shortcutReplayAudio: 'Replay audio',
    shortcutRevealNextLetter: 'Reveal next letter',
  ...
  customLists: {
    ...
    errorWelshRequired: 'Add a Welsh spelling for this row.',
    errorWelshTooLong: 'Keep Welsh spellings under 80 characters.',
    errorEnglishTooLong: 'Keep English meanings under 120 characters.',
