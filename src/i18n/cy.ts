export const cy = {
  ...
  practice: {
    ...
    keyboardHint: 'Ailchwarae sain · Datgelu’r llythyren nesaf',
    shortcutReplayAudio: 'Ailchwarae sain',
    shortcutRevealNextLetter: 'Datgelu’r llythyren nesaf',
  ...
  customLists: {
    ...
    errorWelshRequired: 'Ychwanegwch sillafiad Cymraeg ar gyfer y rhes hon.',
    errorWelshTooLong: 'Cadwch sillafiadau Cymraeg o dan 80 nod.',
    errorEnglishTooLong: 'Cadwch ystyron Saesneg o dan 120 nod.',
