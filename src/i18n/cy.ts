export const cy = {
  ...
  footer: {
    ...
    aboutBody1: 'Fersiwn beta 0.2. Adeiladwyd gan Sam Gerrard.',
    aboutBody2: 'Mae Spelio yn ap ymarfer sillafu Cymraeg canolbwyntiedig.',
    aboutBody3: 'Mae’n helpu dysgwyr i feithrin hyder mewn sillafu Cymraeg drwy wrando, cofio ac ymarfer sillafu dro ar ôl tro.',
    aboutBody4: 'Gall sillafu Cymraeg edrych yn anghyfarwydd ar y dechrau, ond mae’n aml yn fwy rhagweladwy nag y mae’n ymddangos. Mae Spelio wedi’i gynllunio i helpu dysgwyr i ddod yn fwy cyfforddus yn adnabod patrymau sillafu Cymraeg, cysylltu Cymraeg llafar â Chymraeg ysgrifenedig, a datblygu hyder sillafu go iawn yn raddol.',
    aboutBody5: 'Mae’r ap wedi’i gynllunio i ategu ffyrdd eraill o ddysgu Cymraeg, nid i gymryd eu lle.',
    aboutBody6: 'Dechreuodd Spelio tra oeddwn i’n dysgu Cymraeg fy hun. Roeddwn i’n gweld nad oedd clywed geiriau’n ddigon bob tro — roedd angen i mi eu gweld, eu teipio, ac ymarfer eu sillafu cyn iddynt aros yn iawn yn fy nghof. Doeddwn i ddim yn gallu dod o hyd i offeryn oedd yn canolbwyntio ar y rhan honno o ddysgu, felly dechreuais adeiladu’r un yr oeddwn i’n dymuno ei fod eisoes yn bodoli ochr yn ochr â’r adnoddau Cymraeg eraill roeddwn yn eu defnyddio.',
    aboutBody7: 'Dydw i ddim yn athro Cymraeg nac yn ieithydd — dim ond rhywun oedd eisiau gwella ar sillafu Cymraeg. Mae adeiladu Spelio wedi bod yn rhan o’r daith honno, ac fe wnaeth fy mhrofiad fy hun gyda dyslecsia atgyfnerthu pa mor werthfawr y gall ymarfer sillafu syml, dro ar ôl tro, fod.',
