export const cy = {
  ...
  footer: {
    ...
    aboutBody6: 'Dechreuodd y prosiect wrth ddysgu Cymraeg yn bersonol. Fel dysgwr dyslecsig, roeddwn i’n gweld nad oedd clywed geiriau’n ddigon bob tro — roedd angen i mi weld geiriau, eu teipio, ac ymarfer eu sillafu er mwyn eu cofio’n iawn. Adeiladwyd Spelio i greu’r math o offeryn ymarfer syml a chanolbwyntiedig yr oeddwn i’n dymuno ei gael ochr yn ochr â’r adnoddau Cymraeg eraill roeddwn yn eu defnyddio.',
